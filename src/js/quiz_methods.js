...
// attest/issue badge
var desc = ['Je hebt het diploma GYMNASIUM behaald',
'Je hebt het diploma VWO behaald',
'Je hebt het diploma HAVO behaald',
'Je hebt het diploma VMBO behaald']
var title = ["GYMNASIUM", "VWO", "HAVO", "VMBO"];

// attest/issue badge
const uportAttest = function (arg1, arg2) {
    lab_connector.attestCredentials({
        sub: user_data.uportId,
        claim: {
            Diploma: {
